...
losses=train(model, generate_gaussian_nd, nn_dist, criterion=nn.MSELoss(), steps=15000, lr=1e-3, n=2)

print(sum(losses[-10:])/10)
show_examples(model, generate_gaussian_nd, nn_dist, samples=4, n=2, set_size=(5,6))
show_examples(model, generate_gaussian_nd, nn_dist, samples=4, n=3, set_size=(5,6))
show_examples(model, generate_gaussian_nd, nn_dist, samples=4, n=4, set_size=(5,6))

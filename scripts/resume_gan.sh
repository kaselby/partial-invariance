...
do
    ...
    sbatch scripts/train_gan.sh "${run_name}_union/$i" "union" $merge $data $n $latent_size $hidden_size $bs $lr $steps $set_size1 $set_size2 $warmup_steps $weight_sharing $ln $num_blocks $decoder_layers $basedir $((7772219+2*i))

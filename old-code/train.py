...
if __name__ == '__main__':
    ...
    if not args.old_model:
        if args.model == 'csab':
            ...
            model = UnionTransformer(args.dim, args.latent_size, args.hidden_size, 1, **model_kwargs).to(device)
        else:
    ...
    torch.save({'losses':losses, 'args':args, 'eval_loss':eval_loss}, os.path.join(run_dir,"logs.pt"))   

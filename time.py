...
t_model = timeit.timeit(lambda: test(generator, model, n=32, set_size=(500,1000)), number=1000)
t_baseline = timeit.timeit(lambda: test(generator, baseline, n=32, set_size=(500,1000)), number=1000)
